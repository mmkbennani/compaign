...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const {
    account: { isOwner },
    data: { eventLogs, getCampaignCount },
    queries: {
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/" className="flex items-center gap-2 font-semibold">
          <Image alt="CarbonThink logo" className="h-6 w-6" width={176} height={32} priority src={"/images/carbonthink.svg"} />
            ...
            {/* <!-- Menu Item Dashboard --> */}
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    (pathname === "" || pathname === "/" || pathname.includes("dashboard") ) &&
              ...
              <li>
                ...
                >
                  ...
                  Projects ({campaignCountSuccess?Number(getCampaignCount ?? 0):''})
                </Link>
              </li>
              {/* <!-- Menu Item Projects --> */}
              ...
              <li>
                <Link
                  href="/burn"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("burn") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
              ...
              ? <li>
                <Link
                  href="/create"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("create") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-square-plus"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M8 12h8"/><path d="M12 8v8"/></svg>
                  New project
                </Link>
              </li>
              : <></>}
